...
// Performance-marketing: the fundamental features of an autonomous ad-budget
// agent, each harnessed as a guardrail the loop learns (ButterflyLedger + Ch. 3.3).
export {
  PROBES as PM_PROBES,
  GUARDRAIL_RULE as PM_GUARDRAIL_RULE,
  OVERBROAD_FREEZE_RULE,
  type PmFeature,
  type PmPathology,
  type PmProbe,
} from "./examples/performance-marketing/catalog.js";
export { PmAgent, type PmTask, type PmResult } from "./examples/performance-marketing/pm-agent.js";
export { PmHeuristicProposer } from "./examples/performance-marketing/pm-proposer.js";
export { buildPmSuite } from "./examples/performance-marketing/tasks.js";
export { runPmDemo } from "./examples/performance-marketing/run.js";
